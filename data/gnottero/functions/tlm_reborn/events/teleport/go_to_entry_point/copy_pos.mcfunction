#> Store the value of the player entry point inside the coordinate of the aec
    #> Called by the "gnottero:tlm_reborn/events/teleport/go_to_entry_point/summon_aec" function
    ...
    #> Call the "gnottero:tlm_reborn/events/teleport/go_to_entry_point/teleport_to_pos" function
        function gnottero:tlm_reborn/events/teleport/go_to_entry_point/teleport_to_pos