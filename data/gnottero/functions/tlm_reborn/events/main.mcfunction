#> Main function of the events handlers
    ...
    #> If the player drops a placeholder, then kill it
        execute if entity @e[type=item,tag=!global.ignore.kill,distance=..5.5,nbt={Item:{tag:{CustomModelData:1280200}}}] run kill @e[type=item,distance=..5.5,nbt={Item:{tag:{CustomModelData:1280200}}}]
